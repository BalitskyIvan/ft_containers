...
public:
    ...
    class reverse_iterator : public std::iterator<std::bidirectional_iterator_tag, const T> {
    public:
        value_type *item;
        ...
        reverse_iterator operator+(difference_type val) const { return reverse_iterator(item - val); };

        reverse_iterator operator-(difference_type val) const { return reverse_iterator(item + val); };

        difference_type operator+(reverse_iterator &it) const { return item - it.item; }
        ...
        const_reference operator[](const_reference ref) const { return *(item - ref); };

        reference operator*() { return *this->item; }

        pointer operator->() { return this->item; }

        bool operator==(const reverse_iterator &other) const { return item == other.item; };
        ...
        bool operator==(const const_reverse_iterator &other) const { return  item == other.item; };
